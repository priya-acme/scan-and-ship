...
if ($code) {
    ...
    if (empty($shop_info)) {
        //echo "okkkk";// this means that's it's a fresh installation, so we do the installation process
...
<form action="" method="post">
    <input type="text" name="shop" value="" placeholder="your-store.myshopify.com" />
