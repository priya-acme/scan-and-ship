...
class Shopify {
	...
	{
		$curl_url = "https://$shop/admin/orders.json?limit=250&page=$count&status=any&fulfillment_status=fulfilled&created_at_min=".$date."T16:15:47-04:00";
		//echo $curl_url;
		return $this->curlRequest($curl_url, $access_token);
	}
	...
	{
		$curl_url = "https://$shop/admin/orders.json?limit=250&page=$count&status=any&fulfillment_status=unfulfilled&created_at_min=".$date."T16:15:47-04:00";
		//echo $curl_url;
		return $this->curlRequest($curl_url, $access_token);
	}
