...
include __DIR__ .'../../includes/utils/Shopify.php';
 ...
 $create_fulfillment = $Shopify->create_fulfillment_order($shop, $shop_info['access_token'],'5924277133',array("fulfillment"=>array("tracking_number"=>null,array("line_items"=>array("id"=>"10647795149","id"=>"10647795213","quantity"=>"0")))));
 echo "<pre>";
 print_r($orders);
