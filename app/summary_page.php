...
$cache_file     = md5($dynamic_url).$cache_ext; // construct a cache file
...
<?php if($get_verification['verification_step'] != 'Three') {  ?> <span class="role2 summary-role">SELECT ROLE :<?php echo $dynamic_url;?></span><?php } ?>
